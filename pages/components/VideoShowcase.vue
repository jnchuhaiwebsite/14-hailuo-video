    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        <h2 class="text-2xl sm:text-3xl font-extrabold text-white sm:text-4xl">
          Explore the Hailuo AI Video Showcase
        </h2>
        <p class="mt-4 text-base sm:text-xl text-gray-300">
          See How Hailuo AI Turns Text and Images into High-Quality 1080p Videos for Your Business, Social Media, and Education.
        </p>
      </div>
      
      <div class="mt-8 sm:mt-16 max-w-10xl mx-auto">
        <div class="bg-blue-pale/80 rounded-lg overflow-hidden shadow-xl">
          <div class="relative flex items-center justify-center bg-black aspect-video">
            <!-- Loading state -->
            <div v-if="isLoading" class="absolute inset-0 flex justify-center items-center bg-black/50 z-10">
              <div class="animate-spin rounded-full h-8 w-8 sm:h-12 sm:w-12 border-4 border-[#7C3AED] border-t-transparent"></div>
            </div>
...
// Video configuration
const videoSrc = 'https://resp.hailuo2.com/hailuo/example/hailuo2-video.mp4'
const posterSrc = 'https://resp.hailuo2.com/hailuo/home/hailuo2-video.webp'
